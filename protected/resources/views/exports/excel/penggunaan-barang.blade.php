<table style="border: 20px black solid;">
    <thead>
        <tr>
            <th colspan="5" style="text-align: center; font-weight:bold; font-size: 16px;">PT Jaringan Putra Nusantara
            </th>
    ...
    <tbody>
        @foreach ($data as $i => $item)
            <tr>
                ...
                <td style="text-align: center; padding: 0 5px; width: 150px;">{{ $item->nama_gudang }}</td>
            </tr>
        @endforeach
    </tbody>
</table>
