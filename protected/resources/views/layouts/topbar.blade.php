<header id="page-topbar">
    <div class="navbar-header">
        ...
        <div class="d-flex">
            ...
            <span class="d-none d-xl-inline-block ms-1" key="t-henry">{{Auth::user() ? ucfirst(Auth::user()->full_name) : 'admin'}}</span>
            <i class="mdi mdi-chevron-down d-none d-xl-inline-block"></i>
            </button>
            <div class="dropdown-menu dropdown-menu-end">
                <!-- item-->
                <a class="dropdown-item" href="contacts-profile"><i class="bx bx-user font-size-16 align-middle me-1"></i> <span key="t-profile">Data personal</span></a>
            ...
            <div class="modal-body">
                <form method="POST" id="change-password">
                    ...
                    <div class="mt-3 d-grid">
                        <button class="btn btn-primary waves-effect waves-light UpdatePassword" data-id="{{Auth::user() ? Auth::user()->id : ''}}" type="submit">Update Password</button>
                    </div>
                </form>
            </div>
        </div><!-- /.modal-content -->
