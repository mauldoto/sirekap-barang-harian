                ...
                <form action="{{route('akomodasi.update', $akomodasi->no_referensi)}}" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="mb-2 col-lg-5">
                            ...
                            <input class="form-control" type="number" name="nominal_pengajuan" value="{{$akomodasi->nominal_pengajuan}}" required>
                        </div>
    
                        <div class="mb-2 col-lg-5">
                            <label class="form-label">Nominal Realisasi</label>
                            <input class="form-control" type="number" name="nominal_realisasi" value="{{$akomodasi->nominal_realisasi}}" required>
                        </div>
