...
@section('content')
                ...
                <div class="card-body">
                    <div class="d-sm-flex flex-wrap justify-content-between">
                        ...
                        <div class="button-group">
                            <a href="{{ route('akomodasi.input') }}" class="btn btn-sm btn-success"><i
                                    class='bx bx-archive-in'></i> Input Akomodasi</a>
                        ...
                        <tbody>
                            @foreach ($akomodasi as $key => $i)
                                <tr>
                                    ...
                                    <td><a href="{{ route('akomodasi.open', $i->no_referensi) }}" target="_blank"
                                            rel="noopener noreferrer">{{ $i->no_referensi }}</a></td>
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <div class="dropdown-menu" style="">
                                                <a class="dropdown-item detail-btn d-flex align-items-center" href="#"
                                                    data-url="" data-id="{{ $i->no_referensi }}"><i
                                                        class='bx bx-search-alt-2 me-1'></i> Detail</a>
                                            ...
                                            <a class="dropdown-item d-flex align-items-center update-status-btn" href="#" data-url="{{route('akomodasi.update.status', $i->no_referensi)}}" data-status="{{$i->status}}" data-stok="{{$i->stok ? $i->stok->no_referensi : ''}}"><i class='bx bx-task me-1'></i> Update Status</a> --}}
                                                    ...
                                                    <a class="dropdown-item d-flex align-items-center"
                                                        href="{{ route('akomodasi.edit', $i->no_referensi) }}"
                                                        data-url=""><i class='bx bxs-edit me-1'></i> Edit AKM</a>
    ...
    <div id="modalDetail" class="modal fade" tabindex="-1" aria-labelledby="detailLabel" style="display: none;"
        aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <table class="table table-bordered dt-responsive w-100 dataTable no-footer dtr-inline"
                        aria-describedby="datatable_info" style="width: 100%;">
                        <tbody>
                            <tr>
