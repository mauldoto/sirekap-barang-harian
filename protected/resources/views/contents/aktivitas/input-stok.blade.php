...
@slot('title') Stok Keluar @endslot
@endcomponent
        ...
        <div class="card">
            <div class="card-body">
                <div class="d-sm-flex flex-wrap justify-content-between">
                    <h4 class="card-title mb-4">Input Stok Keluar Tiket [{{$aktivitas->no_referensi}}]</h4>
                ...
                <form action="{{route('aktivitas.inputstokout.post', $aktivitas->no_referensi)}}" method="post">
                    ...
                    <div class="mb-2 col-lg-5">
                        ...
                        <input class="form-control" type="hidden" name="noref" value="{{generateReference('SK')}}" required>
                    </div>
