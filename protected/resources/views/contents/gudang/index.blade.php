...
@section('content')
                ...
                <div class="card-body">
                    <form action="{{ route('gudang.store') }}" method="POST">
                        ...
                        <div class="mb-2">
                            ...
                            <input class="form-control" type="text" name="nama" placeholder="Masukkan nama gudang">
                        </div>
                        <div class="mb-2">
                            <label class="form-label">Kode Gudang</label>
                            <input class="form-control" type="text" name="kode"
                                placeholder="Kosongkan jika ingin terisi otomatis">
                        </div>
                        <div class="mb-2">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-sm-flex flex-wrap justify-content-between">
                        <h4 class="card-title mb-4">Daftar Gudang</h4>
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <div class="dropdown-menu" style="">
                                                <a class="dropdown-item edit-btn" href="#"
                                                    data-url="{{ route('gudang.update', $i->id) }}"
                                                    data-id="{{ $i->id }}">Edit</a>
                                                <div class="dropdown-divider"></div>
                                                <a class="dropdown-item delete-btn" style="color: red" href="#"
                                                    data-url="{{ route('gudang.delete', $i->id) }}">Hapus</a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
    ...
    <div id="modalgudang" class="modal fade" tabindex="-1" aria-labelledby="modalgudangLabel" style="display: none;"
        aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modalgudangLabel">Edit Gudang</h5>
    ...
    <div id="modalImport" class="modal fade" tabindex="-1" aria-labelledby="modalImportLabel" style="display: none;"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modalImportLabel">Import Gudang</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                ...
                <div class="modal-body">
                    <form action="" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="file" name="import_gudang" class="form-control"
                ...
                <div class="modal-footer d-flex justify-content-end">
                    <a href="{{ asset('assets/files/import_gudang_format.xlsx') }}" class="text-success">Download Format
                        Import</a>
                </div>
            </div><!-- /.modal-content -->
        </div><!-- /.modal-dialog -->
    ...
    <script>
        $(document).ready(function() {
            ...
            function getDetail(ids) {
                $.get('gudang/' + ids + '/detail').done(function(response) {
                    let res = response
            ...
            function showModal() {
                const myModal = new bootstrap.Modal('#modalgudang', {
                    show: true
                })
                myModal.show()
            }

            $('#datatable-gudang').on('click', '.edit-btn', function() {
                getDetail($(this).data('id'))
                $('.modal-form').attr('action', $(this).data('url'))
            })

            $("#datatable-gudang").on("click", ".delete-btn", function() {
