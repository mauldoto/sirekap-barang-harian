        ...
        <div class="items" data-group="">
            ...
            <div class="item-content">
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <select class="form-control barang-select2" id="inputItem" data-name="item" disabled>
                            <option value=""></option>
                        </select>
                    </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            $(".generate-btn").click(function () {
                ...
                if ($('.gudang-select2').hasClass("select2-hidden-accessible")) {
                    $('.gudang-select2').select2('destroy');
                }
