...
@section('content')
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <div class="dropdown-menu" style="">
                                                <a class="dropdown-item edit-btn" href="#"
                                                    data-url="{{ route('barang.update', $i->id) }}"
                                                    data-id="{{ $i->id }}">Edit</a>
                                                <div class="dropdown-divider"></div>
                                                <a class="dropdown-item delete-btn" style="color: red" href="#"
                                                    data-url="{{ route('barang.delete', $i->id) }}">Hapus</a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
    ...
    <div id="modalbarang" class="modal fade" tabindex="-1" aria-labelledby="modalbarangLabel" style="display: none;"
        aria-hidden="true">
